        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20 tm_mb10_md">
            <div class="tm_invoice_left">
                <div class="tm_logo"><img src="{{ asset('images/logo.png') }}" alt="Logo"></div>
            </div>
          ...
          <div class="tm_invoice_info tm_mb10">
            <div class="tm_invoice_info_left">
              ...
              <p>
                <b class="tm_f16 tm_primary_color">{{ $invoice->user->name }}</b> <br>
                {{ $invoice->user->email }} <br>
              </p>
            </div>
            <div class="tm_invoice_info_right">
              <div class="tm_f50 tm_text_uppercase tm_text_center tm_invoice_title tm_mb15 tm_ternary_color tm_mobile_hide">{{ $invoice->status }}</div>
              <div class="tm_grid_row tm_col_2 tm_invoice_info_in tm_round_border tm_gray_bg">
                <div>
                  <span>Invoice No:</span> <br>
                  <b class="tm_f18 tm_accent_color">{{ $invoice->invoice_number }}</b>
                </div>
                <div>
                  <span>Invoice Date:</span> <br>
                  <b class="tm_f18 tm_accent_color">{{ $invoice->issued_date->format('Y-m-d') }}</b>
                </div>
          ...
          <div class="tm_table tm_style1">
            <div class="tm_round_border">
              <div class="tm_table_responsive">
                <table>
                  <thead>
                    <tr>
                      <th class="tm_width_7 tm_semi_bold tm_primary_color">Product/Service</th>
                  ...
                  <tbody>
                    @foreach ($orders as $order)
                      <tr class="{{ $loop->index % 2 == 0 ? 'tm_gray_bg' : '' }}">
                        <td class="tm_width_7">
                          <p class="tm_m0 tm_f16 tm_primary_color">{{ $order->product->title ?? 'Custom Request' }}</p>
                          {{ $order->product->description ?? 'No description available' }}
                        </td>
                        <td class="tm_width_2">@rupiah($order->product->price ?? $order->customRequest->price)</td>
                        <td class="tm_width_1">{{ $order->quantity ?? 1 }}</td>
                        <td class="tm_width_2 tm_text_right">@rupiah(($order->product->price ?? $order->customRequest->price) * ($order->quantity ?? 1))</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
            ...
            <div class="tm_invoice_footer tm_mb15 tm_m0_md">
              <div class="tm_left_footer">
                ...
                <p class="tm_mb5">
                  <b class="tm_primary_color">Payment Methods:</b> <br>
                  Xendit                </p>
                <p class="tm_mb0">
                ...
                <table class="tm_mb15">
                  <tbody>
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_bold">@rupiah($invoice->total_amount)</td>
                    </tr>
                    <tr>
                      <td class="tm_width_3 tm_danger_color tm_border_none tm_pt0">Discount</td>
                      <td class="tm_width_3 tm_danger_color tm_text_right tm_border_none tm_pt0">@rupiah($invoice->discount_amount)</td>
                    </tr>
                    <tr>
                      <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Tax</td>
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0">@rupiah($invoice->tax_amount)</td>
                    </tr>
                    <tr>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_white_color tm_accent_bg tm_radius_6_0_0_6">Grand Total</td>
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_white_color tm_accent_bg tm_radius_0_6_6_0">@rupiah($invoice->total_amount - $invoice->discount_amount + $invoice->tax_amount)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
